...
case "$perladmin" in
'') perladmin='atc135@el6build.test.psu.edu' ;;
esac
...
case "$prefix" in
'') prefix='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard' ;;
esac
...
case "$siteprefix" in
'') if test "/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard" = "/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard"; then
	siteprefix="$prefix"
    else
	siteprefix='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard" = "/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard"; then
	...
	installprefix='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard'
    fi
    ;;
esac
...
#     /tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard, so it isn't included here either.
#
...
# bin='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/bin'
# scriptdir='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/bin'
# privlib='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/lib/perl5/5.26.1'
# archlib='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/lib/perl5/5.26.1/x86_64-linux'
# man1dir='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/man/man1'
# man3dir='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/man/man3'
# man1ext='1'
# man3ext='3'
...
html3dir=' '
# sitebin='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/bin'
# sitescript='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/bin'
# sitelib='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/lib/perl5/site_perl/5.26.1'
# sitearch='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/lib/perl5/site_perl/5.26.1/x86_64-linux'
# siteman1dir='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/man/man1'
# siteman3dir='/tmp/vessel_rancid-shipyard-Bfe7Fh/rancid-shipyard/man/man3'
# sitehtml1dir=''
# sitehtml3dir=''
# vendorbin=''
# vendorscript=''
